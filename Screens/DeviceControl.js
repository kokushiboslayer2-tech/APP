...
export default function DeviceControl({navigation,route}) {
    ...
    const fetchUserProfile = async(token) => {
        if(!token)return;
        try{
            const Response = await fetch('http://moonhub.moonpreneur.com/LMSService/api/IOT/UserProfile',{
                method:'GET',
    ...
    const fetchComponents = async(apiToken) => {
        fetchUser(apiToken);
        try{
            const response = await fetch(`http://moonhub.moonpreneur.com/LMSService/api/IOT/GetDeviceComponents?user_device_id=${device.user_device_id}`, {
                method:'GET',
                headers:{
    ...
    const togglecomponentStatus = async(componentId, currentStatus) => {
        ...
        try {
            const response = await fetch('http://moonhub.moonpreneur.com/LMSService/api/IOTDevice/UpdateComponentStatus', {
                method: 'POST',
                headers: {
    ...
    const savecomponent = async () => {
        ...
        try{
          const response = await fetch('http://moonhub.moonpreneur.com/LMSService/api/IOT/AddUpdateComponent', {
            method: 'POST',
            headers:{
